...
<body>
	...
	switch (actionType) {
		...
		case "CREATE" : // 회원가입
			...
			mem_RRN = String.valueOf(request.getParameter("mem_RRN1")) + "-"
			+ String.valueOf(request.getParameter("mem_RRN2"));
	...
	userID = request.getParameter("userid"); //사용자가 입력한 아이디를 저장한다.
	userPW = request.getParameter("passwd"); //사용자가 입력한 비밀번호를 저장한다.
	...
	sql = "update member set mem_name='" + mem_name + "', mem_passwd='" + mem_passwd + "',mem_email='" + mem_email
			+ "',mem_phone='" + mem_phone + "'";
