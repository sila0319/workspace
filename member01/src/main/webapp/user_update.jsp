...
<body>
<% session.setAttribute("viewState", "update1"); %>
...
%>
   ...
   %>
      <tr>
         ...
         <td><%=mem_class %></td>
         <td>
         <a href="./user_update2.jsp?mem_num=<%=mem_num%>&mem_name=
         <%=mem_name%>&mem_id=<%=mem_id%>&mem_passwd=<%=mem_passwd%>
         &mem_email=<%=mem_email%>&mem_phone=<%=mem_phone%>&mem_class=<%=mem_class%>">수정</a>
         </td>
