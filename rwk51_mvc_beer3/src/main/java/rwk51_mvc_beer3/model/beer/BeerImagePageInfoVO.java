...
public class BeerImagePageInfoVO {
	...
	private String displayBeer;
	
	public BeerImagePageInfoVO() {
		super();
		...
		this.displayBeer = "all";
	}
	public BeerImagePageInfoVO(int limitCnt, int recordCnt, int pageCnt, int startRecord, int currentPageNo, int startPageNo,
			int endPageNo) {
		super();
	...
	public String getDisplayBeer() {
		return displayBeer;
	}
	public void setDisplayBeer(String displayBeer) {
		this.displayBeer = displayBeer;
	}
