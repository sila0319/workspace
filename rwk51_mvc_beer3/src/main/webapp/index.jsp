...
<h2>맥주샵 시스템 - CRUD with MVC #2</h2>
 ...
 <h2>MVC페턴적용, DAO,DTO,VO활용, ()DBCP/서블릿/스프링 미적용)</h2> 
...
<li><a href="<%= beerViewDir%>/beer_r_drc2.jsp">출력레코드 갯수조정(R_DRC2)</a>
<li><a href="<%= beerViewDir%>/beer_c.jsp">맥주 정보입력(C)</a>
 <li><a href="<%= beerViewDir%>/beer_c2.jsp">맥주 정보입력2(C)</a> 
<li><a href="./BeerController.be?actionType=R">맥주정보조회(R,페이징기능X)</a>
<li><a href="./BeerController.be?actionType=R4">맥주정보조회(R4, MVC패턴적용)</a>
<li><a href="./BeerController.be2?actionType=R5">맥주정보조회(R5, MVC패턴적용)</a>
