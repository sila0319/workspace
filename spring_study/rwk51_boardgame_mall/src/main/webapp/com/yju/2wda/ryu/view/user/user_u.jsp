...
<div class="container-xl">
    <div class="table-responsive">
		...
		<tr>
			...
			<td><a href ="./updateUserDisplay.be?user_num=<%=user.getUser_num()%>">UPDATE</a></td>
		</tr>
		<%
		}
		%>
	...
	<li class="page-item disabled"><a href="./updateUserListDisplay.be?currentPageNo=0">[FIRST]</a></li>
	<%      
   
   if(currentPageNo > 0 ){
%>
  <li class="page-item"><a href="./updateUserListDisplay.be?currentPageNo=<%=(currentPageNo-1) %>">[PRE]</a></li>
...
%>
 ...
 %>
   <li class="page-item"><a href="./updateUserListDisplay.be?currentPageNo=<%=(i) %>">[<%=(i+1) %>]</a></li>
 <%
      }
   }
...
<%
 ...
 %>
 <li class="page-item" ><a href="./updateUserListDisplay.be?currentPageNo=<%=(currentPageNo+1) %>">[NXT]</a></li>
 <%
   }else{
 %>
 [NXT]
 ...
 %>
  <li class="page-item"> <a href="./updateUserListDisplay.be?currentPageNo=<%=(upiVO.getPageCnt()-1)%>">END</a></li>
  </ul>
  </div>
	        </div>
    </div>
