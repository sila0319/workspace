...
public class UpdateBoardgameForIdAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");
		
		System.out.println("UpdateBoardgameForIdAction");
		
		int maxSize = 1024*1024*5;
		String imgDirPath ="D:\\dev\\workspace\\rwk51_boardgame_mall\\src\\main\\webapp\\image\\original\\";
		String thumbimgDirPath="D:\\dev\\workspace\\rwk51_boardgame_mall\\src\\main\\webapp\\image\\thumb\\";
		...
		boardgame.setB_id(Integer.parseInt(multi.getParameter("b_id")));
		...
		if(files.hasMoreElements()) {
			...
			String oPath = imgDirPath+file_name; // 원본 경로
			   ...
			   BufferedImage oImage = ImageIO.read(oFile); // 원본이미지
				...
				boardgame.setB_image(multi.getParameter("b_image2"));
				System.out.println(boardgame.getB_image());
			}
		...
		boolean result = boardgameDAO.updateBoardgame(boardgame);
