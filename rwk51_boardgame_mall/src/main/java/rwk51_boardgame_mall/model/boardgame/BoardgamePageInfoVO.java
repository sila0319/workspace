...
public class BoardgamePageInfoVO {
	...
	public BoardgamePageInfoVO(int limitCnt, int recordCnt, int pageCnt, int startRecord, int currentPageNo, int startPageNo,
			int endPageNo) {
		super();
