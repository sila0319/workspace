<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import ="rwk51_mvc_beer4.model.beer.*" %>
...
<head>
<meta charset="UTF-8">
<title>마이쇼핑몰(rwk51) - 맥주자료수정(U)</title>
</head>
<body>
<h1>마이쇼핑몰(rwk51) - 맥주자료수정(U)</h1>
<hr>
...
<%
	...
	//System.out.println("beer_U페이지입니다"+bpiVO.getLimitCnt() );
%>
...
<br>
   ...
   if(currentPageNo > 0 ){
%>
<a href="./updateBeerListDisplay.be?currentPageNo=<%=(currentPageNo-1) %>" >[PIPRE]</a>
